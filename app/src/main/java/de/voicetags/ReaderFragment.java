...
public class ReaderFragment extends SpeakFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_reader, container, false);
        return rootView;
    }
    ...
    public void onResume() {
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(getActivity().getIntent().getAction())) {
            ...
            if (rawMsgs != null) {
                ...
                TextView nfcContentView = (TextView) getActivity().findViewById(R.id.fragNfcContent);
